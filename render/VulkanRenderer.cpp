...
namespace aga
{
    ...
    bool VulkanRenderer::CreateSwapChainImages()
    {
        ...
        {
            m_SwapChainImagesViews[i] = _CreateImageView(m_SwapChainImages[i], m_SurfaceFormat.format);
        }
    ...
    VkImageView VulkanRenderer::_CreateImageView(VkImage image, VkFormat format)
    {
